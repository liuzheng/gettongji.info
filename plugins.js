...
jQuery(function ($) {
	$.fn.quicksearch = function (opt) {
		...
		function make_form_input()
		{
			...
			return '<input type="text" value="' + val + '" rel="' + options.randomElement  + '" class="' + options.inputClass + '" id="' + options.randomElement + '" placeholder="Search"/> ';
		}
				...
				setTimeout(function () {
					...
					if (k != "")
					{
						...
						if (score[k].length === 0)
						{
							...
							select_element(el).removeClass("score");
						}
						else
						{
							$(el).each(function (i) {
								if (score[k][i])
								{
									...
									select_element(this).addClass("score");
								}
								else
								{
									//select_element(this).hide();
									select_element(this).removeClass("score");
								}
							});
					...
					else
					{
						...
						select_element(el).addClass("score");
					}
